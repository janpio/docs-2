export const description = 'Comparison to AWS CDK'
...
3. **Infrastructure Provisioning:** Nitric uses Pulumi by default for provisioning cloud resources, but also allows the use of [custom providers](/reference/providers/custom/building-custom-provider). AWS CDK uses AWS CloudFormation for provisioning.
...
| Extensibility                      | [Custom providers](/reference/providers/custom/building-custom-provider) can be created | Custom Constructs / Resource Providers                                                                  |
| Local simulation                   | Built-in local simulator with instant hot reloading                                     | No                                                                                                      |
| Supports all major cloud providers | Yes                                                                                     | No                                                                                                      |
